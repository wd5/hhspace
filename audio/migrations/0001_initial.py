...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('audio_audio', (
            ...
            ('music_author', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('words_author', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('year', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('right_to', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
    ...
    models = {
        'audio.audio': {
            ...
            'music_author': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'right_to': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'words_author': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
