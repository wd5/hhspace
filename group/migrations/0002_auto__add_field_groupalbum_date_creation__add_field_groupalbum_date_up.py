...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupAlbum.date_creation'
        db.add_column('group_groupalbum', 'date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 5, 31), blank=True), keep_default=False)

        # Adding field 'GroupAlbum.date_update'
        db.add_column('group_groupalbum', 'date_update', self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.date(2011, 5, 31), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupAlbum.date_creation'
        db.delete_column('group_groupalbum', 'date_creation')

        # Deleting field 'GroupAlbum.date_update'
        db.delete_column('group_groupalbum', 'date_update')
    ...
    models = {
        ...
        'group.group': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 31, 2, 37, 31, 330135)', 'auto_now': 'True', 'blank': 'True'}),
            'directions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['account.Direction']", 'symmetrical': 'False'}),
            'featuring': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'styles': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['account.Style']", 'symmetrical': 'False'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 31, 2, 37, 31, 330245)', 'auto_now': 'True', 'blank': 'True'})
        },
        'group.groupalbum': {
