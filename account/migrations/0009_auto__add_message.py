...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ffrom', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='from_messages', to=orm['account.CustomUser'])),
            ('to', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='to_messages', to=orm['account.CustomUser'])),
            ('theme', self.gf('django.db.models.fields.CharField')(default='', max_length=150)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('account', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'Message'
        db.delete_table('account_message')
    ...
    models = {
        ...
        'account.photocomment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': "'2011-07-03'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
