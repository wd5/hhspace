...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'News.name'
        db.delete_column('account_news', 'name')

        # Adding field 'News.title'
        db.add_column('account_news', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)

        # Adding field 'News.subtitle'
        db.add_column('account_news', 'subtitle', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)

        # Changing field 'News.date_created'
        db.alter_column('account_news', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Adding field 'News.name'
        db.add_column('account_news', 'name', self.gf('django.db.models.fields.CharField')(default=datetime.date(2011, 6, 3), max_length=150), keep_default=False)

        # Deleting field 'News.title'
        db.delete_column('account_news', 'title')

        # Deleting field 'News.subtitle'
        db.delete_column('account_news', 'subtitle')

        # Changing field 'News.date_created'
        db.alter_column('account_news', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        'account.news': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subtitle': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150'}),
