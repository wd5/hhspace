...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BookmarkUser'
        db.create_table('account_bookmarkuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='bookmarks_users', to=orm['account.CustomUser'])),
            ('mark', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='mark_users', to=orm['account.CustomUser'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('account', ['BookmarkUser'])


    def backwards(self, orm):
        
        # Deleting model 'BookmarkUser'
        db.delete_table('account_bookmarkuser')
    ...
    models = {
        ...
        'account.photocomment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': "'2011-07-04'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
