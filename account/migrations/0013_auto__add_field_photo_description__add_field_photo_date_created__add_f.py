...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_photo', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=250), keep_default=False)

        # Adding field 'Photo.date_created'
        db.add_column('account_photo', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default='', blank=True), keep_default=False)

        # Adding field 'SingerAlbum.year'
        db.add_column('account_singeralbum', 'year', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.description'
        db.delete_column('account_photo', 'description')

        # Deleting field 'Photo.date_created'
        db.delete_column('account_photo', 'date_created')

        # Deleting field 'SingerAlbum.year'
        db.delete_column('account_singeralbum', 'year')
    ...
    models = {
        ...
        'account.bookmarkuser': {
            'Meta': {'object_name': 'BookmarkUser'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mark': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'mark_users'", 'to': "orm['account.CustomUser']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'bookmarks_users'", 'to': "orm['account.CustomUser']"})
        },
        'account.category': {
        ...
        'account.message': {
            ...
            'ffrom': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'from_messages'", 'to': "orm['account.CustomUser']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_read': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'theme': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150'}),
            'to': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'to_messages'", 'to': "orm['account.CustomUser']"})
        },
        'account.photo': {
        ...
        'account.photocomment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': "'2011-07-05'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
