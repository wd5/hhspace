...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.flvideo'
        db.delete_column('account_video', 'flvideo')

        # Adding field 'Video.mp4_video'
        db.add_column('account_video', 'mp4_video', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Video.flvideo'
        db.add_column('account_video', 'flvideo', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Deleting field 'Video.mp4_video'
        db.delete_column('account_video', 'mp4_video')
    ...
    models = {
        ...
        'account.video': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mp4_video': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150', 'blank': 'True'}),
