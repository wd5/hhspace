...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Singer.date_created'
        db.add_column('account_singer', 'date_created', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Singer.street'
        db.add_column('account_singer', 'street', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Singer.date_created'
        db.delete_column('account_singer', 'date_created')

        # Deleting field 'Singer.street'
        db.delete_column('account_singer', 'street')
    ...
    models = {
        ...
        'account.photocomment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': "'2011-07-02'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
