...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('southut_knight', 'dances_whenever_able', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Knight.dances_whenever_able'
        db.delete_column('southut_knight', 'dances_whenever_able')
