...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('southut_knight', 'shrubberies', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Knight.shrubberies'
        db.delete_column('southut_knight', 'shrubberies')
