...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('photoalbum_comment', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateField')(default='2011-05-16', auto_now=True, auto_now_add=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')(default='')),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.CustomUser'])),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['photoalbum.Photo'])),
        ))
    ...
    models = {
        ...
        'photoalbum.comment': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': "'2011-05-16'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
