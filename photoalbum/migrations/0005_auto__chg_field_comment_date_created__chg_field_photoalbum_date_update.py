...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('photoalbum_comment', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'Photoalbum.date_updated'
        db.alter_column('photoalbum_photoalbum', 'date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Comment.date_created'
        db.alter_column('photoalbum_comment', 'date_created', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True))

        # Changing field 'Photoalbum.date_updated'
        db.alter_column('photoalbum_photoalbum', 'date_updated', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'photoalbum.comment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': "'2011-05-21'", 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['photoalbum.Photo']"}),
