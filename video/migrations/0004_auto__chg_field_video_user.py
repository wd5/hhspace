...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('video_video', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Singer']))


    def backwards(self, orm):
        
        # Changing field 'Video.user'
        db.alter_column('video_video', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.CustomUser']))
    ...
    models = {
        ...
        'video.video': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['account.Singer']"}),
