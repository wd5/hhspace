...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.flvvideo'
        db.add_column('video_video', 'flvvideo', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.flvvideo'
        db.delete_column('video_video', 'flvvideo')
