...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('video_video', 'user_id')

        # Adding field 'Video.singer'
        db.add_column('video_video', 'singer', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.Singer']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Video.user'
        db.add_column('video_video', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['account.Singer']), keep_default=False)

        # Deleting field 'Video.singer'
        db.delete_column('video_video', 'singer_id')
